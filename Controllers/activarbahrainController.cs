...
namespace PlaneraAdmin.Controllers
{
    ...
    public class ActivarBahrainController : ControllerBase
    {
        private readonly IWebHostEnvironment _env;
        activarbahrainService _service;
      
        public ActivarBahrainController(IWebHostEnvironment env)
        {
            _service = new activarbahrainService();
            _env = env;
        }
        //Gallery
        [HttpGet("all")]
