...
import { ActDubHomePageService } from 'src/app/_services/actdubhome.service';
...
export class ActDubHomeComponent implements OnInit {
  ...
  home: HomePage[] = [];
  constructor(public service: ActDubHomePageService,
