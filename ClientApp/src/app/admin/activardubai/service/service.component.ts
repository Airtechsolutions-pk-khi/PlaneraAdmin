...
import { ActDubServiceService } from 'src/app/_services/actdubservice';
...
export class ActDubServiceComponent implements OnInit {
  ...
  gallery: Service[] = [];
  constructor(public service: ActDubServiceService,
