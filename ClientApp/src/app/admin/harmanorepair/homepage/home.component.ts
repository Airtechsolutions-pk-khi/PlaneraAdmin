...
import { HrRprHomePageService } from 'src/app/_services/hrrprhome.service';
...
export class HrRprHomeComponent implements OnInit {
  ...
  home: HomePage[] = [];
  constructor(public service: HrRprHomePageService,
