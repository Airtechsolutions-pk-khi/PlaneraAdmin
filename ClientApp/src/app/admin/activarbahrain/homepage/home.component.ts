...
import { ActBahHomePageService } from 'src/app/_services/actbahhome.service';
...
export class ActBahHomeComponent implements OnInit {
  ...
  home: HomePage[] = [];
  constructor(public service: ActBahHomePageService,
