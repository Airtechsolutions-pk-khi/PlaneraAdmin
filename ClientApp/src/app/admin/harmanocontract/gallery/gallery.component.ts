...
import { HrCntGalleryService } from 'src/app/_services/hrcntgallery.service';
...
export class HrCntGalleryComponent implements OnInit {
  ...
  gallery: Gallery[] = [];
  constructor(public service: HrCntGalleryService,
