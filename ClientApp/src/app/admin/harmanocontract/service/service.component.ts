...
import { HrCntServiceService } from 'src/app/_services/hrcntservices.service';
...
export class HrCntServiceComponent implements OnInit {
  ...
  gallery: Service[] = [];
  constructor(public service: HrCntServiceService,
