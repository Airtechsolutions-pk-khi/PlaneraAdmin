...
import { newseventComponent } from './admin/company/newsevent/newsevent.component';
import { AddnewseventComponent } from './admin/company/newsevent/addnewsevent/addnewsevent.component';
@NgModule({
  declarations: [
    AppComponent,
    NavMenuComponent,
    ...
    RouterModule.forRoot([
      { path: '', component: LoginComponent, pathMatch: 'full' },
      {
        ...
        children: [
          ...
          { path: 'newsevent/add', component: AddnewseventComponent },
          { path: 'newsevent/edit/:id', component: AddnewseventComponent },
        ]
      }
    ]),
