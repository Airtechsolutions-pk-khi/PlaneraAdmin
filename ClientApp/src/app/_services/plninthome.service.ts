...
export class PlnIntHomePageService {
  ...
  getById(gethomeid) {
    return this.http.get<HomePage[]>(`api/planerainterior/${gethomeid}`);
  }

  ExportList() {
    return this.http.get<HomePage[]>(`api/planerainterior/homeall`);
  }
  getAllData() {
