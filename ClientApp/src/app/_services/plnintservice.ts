...
export class PlnIntServiceService {
  ...
  getById(id) {
    debugger
    return this.http.get<Service[]>(`api/planerainterior/service/${id}`);
  }

  ExportList() {
    return this.http.get<Service[]>(`api/planerainterior/serviceall`);
  }
  getAllData() {
