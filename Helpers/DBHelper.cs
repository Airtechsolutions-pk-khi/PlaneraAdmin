...
namespace WebAPICode.Helpers
{
    public class DBHelper
    {
        ...
        private static readonly string connectionString = "data source=sql5101.site4now.net;initial catalog=db_a70c38_planera;persist security info=True;user id=db_a70c38_planera_admin;password=Tech@123;";
